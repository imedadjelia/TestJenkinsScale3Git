pipeline {
    ...
    environment {
        ...
        CUCUMBER_ZIP_PATH = 'target/cucumber-report.zip'
    }
    ...
    stages {
        ...
        stage('Report Cucumber Results to Zephyr Scale') {
            steps {
                script {
                    def apiUrl = " https://api.zephyrscale.smartbear.com/v2/automations/executions/cucumber?projectKey=PSLIB&autoCreateTestCases=true"
